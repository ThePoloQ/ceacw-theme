	...
	<div id="content" class="site-content">
		<div class="wrap">
			<div class="wrap-inside">
				...
				<?php
					if ( function_exists( 'ceacw_breadcrumb_trail' ) && current_theme_supports( 'breadcrumb-trail' ) ) :
						ceacw_breadcrumb_trail( array( 'container' => 'nav', 'show_on_front' => false, 'show_browse' => false, 'before' => '<h2 class="screen-reader-text">' . esc_attr__( 'Breadcrumbs', 'toivo-lite' ) . '</h2><div class="wrap">', 'after' => '</div>' ) );
					endif;
				?>
